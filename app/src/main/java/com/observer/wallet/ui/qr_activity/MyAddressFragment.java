...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(ObsrModule obsrModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(obsrModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = CoinApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String obsrURI = ObsrURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(obsrURI,address.toBase58());
            }
    ...
    public void setModule(ObsrModule module) {
        this.module = module;
    }
    ...
    private void loadAddress(String uri,String addressStr) throws WriterException {
        ...
        if (qrBitmap == null) {
            ...
            Log.i("Util",uri);
            qrBitmap = QrUtils.encodeAsBitmap(uri, px, px, Color.parseColor("#1A1A1A"), WHITE );
        }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_share){
            ...
            AndroidUtils.copyToClipboard(getActivity(),address.toBase58());
