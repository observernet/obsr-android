package com.observer.wallet.data.api

import com.observer.wallet.BuildConfig
import com.observer.wallet.data.model.GithubUpdateRsp
...
interface GithubUpdateService {
    @GET("https://api.github.com/repos/LooorTor/obsr-android/releases/latest")
    fun getGithubUpdateData(): Observable<GithubUpdateRsp>
}