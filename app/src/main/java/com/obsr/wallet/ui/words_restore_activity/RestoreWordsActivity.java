package com.obsr.wallet.ui.words_restore_activity;
...
import com.obsr.wallet.utils.AnimationUtils;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = obsrModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            obsrModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            obsrModule.restoreWallet(mnemonic, CoinAppContext.ANDROID_REPO_FIRST_COMMIT_BY_LOOOR_TOR_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (coinApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!coinApplication.getAppConf().isAppInit()){
                                                            coinApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, CoinAppContext.ENABLE_BIP44_APP_VERSION));
