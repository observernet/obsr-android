package com.obsr.wallet.ui.start_node_activity;
...
public class StartNodeActivity extends BaseActivity {
    ...
    private static final List<PeerData> trustedNodes = CoinCoreContext.IS_TEST? PeerGlobalData.listTrustedTestHosts():listTrustedHosts();
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                coinApplication.setTrustedServer(null);
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = coinApplication.getAppConf().getTrustedNode()!=null;
                coinApplication.setTrustedServer(selectedNode);
        ...
        PeerData pivtrumPeer = coinApplication.getAppConf().getTrustedNode();
