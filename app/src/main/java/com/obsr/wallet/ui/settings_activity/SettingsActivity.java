package com.obsr.wallet.ui.settings_activity;
...
import com.obsr.wallet.module.CoinAppContext;
import com.obsr.wallet.ui.import_watch_only.SettingsWatchOnly;
import com.obsr.wallet.ui.settings_backup_activity.SettingsBackupActivity;
import com.obsr.wallet.ui.settings_network_activity.SettingsNetworkActivity;
import com.obsr.wallet.ui.settings_pincode_activity.SettingsPincodeActivity;
import com.obsr.wallet.utils.CrashReporter;
import com.obsr.wallet.utils.DialogsUtil;
import com.obsr.wallet.utils.IntentsUtils;
import com.obsr.wallet.utils.NavigationUtils;
import com.obsr.wallet.utils.ReportIssueDialogBuilder;
import com.obsr.wallet.BuildConfig;
import com.obsr.wallet.R;
import com.obsr.wallet.ui.base.BaseDrawerActivity;
import com.obsr.wallet.ui.base.dialogs.SimpleTwoButtonsDialog;
import com.obsr.wallet.ui.export_account.ExportKeyActivity;
import com.obsr.wallet.ui.restore_activity.RestoreActivity;
import com.obsr.wallet.ui.settings_rates.SettingsRatesActivity;
import com.obsr.wallet.ui.start_node_activity.StartNodeActivity;
import com.obsr.wallet.ui.tutorial_activity.TutorialActivity;
...
import static com.obsr.wallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
import static global.CoinCoreContext.URL_BLOCK_EXPLORER;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#55476c>LooorTor</font> <br>(c) Obsr Foundation";
        ...
        text_rates.setText(coinApplication.getAppConf().getSelectedRateCoin());
    ...
    private void updateNetworkStatus() {
        ...
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#dd0000>"+ CoinCoreContext.NETWORK_PARAMETERS.getId()+
                                "</font><br>" +
                                "Height<br><font color=#dd0000>"+obsrModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#dd0000>"+
                                obsrModule.getProtocolVersion()+"</font>"
        ...
        SimpleTwoButtonsDialog dialog = DialogsUtil.buildSimpleTwoBtnsDialog(
                ...
                new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                    ...
                    public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                        coinApplication.stopBlockchain();
    ...
    private void launchReportDialog() {
                ...
                R.string.report_issue_dialog_message_issue)
        {
            ...
            protected CharSequence subject() {
                return CoinAppContext.REPORT_SUBJECT_ISSUE+" "+ coinApplication.getVersionName();
            }
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, coinApplication);
            ...
            protected CharSequence collectWalletDump() throws IOException {
                return obsrModule.getWallet().toString(false,true,true,null);
            }
        };
        dialog.show();
    }
