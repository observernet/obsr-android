package com.obsr.wallet.ui.transaction_request_activity;
...
import com.obsr.wallet.ui.transaction_send_activity.AmountInputFragment;
import com.obsr.wallet.utils.DialogsUtil;
import com.obsr.wallet.utils.NavigationUtils;
import com.obsr.wallet.utils.QrUtils;
...
import static com.obsr.wallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = obsrModule.getFreshNewAddress().toBase58();

        NetworkParameters params = CoinCoreContext.NETWORK_PARAMETERS;

        String obsrURI = ObsrURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(obsrURI);
        qrDialog.setQrText(obsrURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        private void updateQr() throws WriterException {
            if (img_qr != null) {
                ...
                Log.i("Util", qrText);
                Bitmap qrBitmap = QrUtils.encodeAsBitmap(qrText, px, px, Color.parseColor("#1A1A1A"), WHITE);
        ...
        public static QrDialog newInstance(String obsrURI) throws WriterException {
