package com.obsr.wallet.ui.pincode_activity
...
import com.obsr.wallet.ui.backup_mnemonic_activity.MnemonicActivity
import com.obsr.wallet.ui.backup_mnemonic_activity.MnemonicActivity.INTENT_EXTRA_INIT_VIEW
import com.obsr.wallet.ui.base.BaseActivity
import com.obsr.wallet.ui.settings_pincode_activity.KeyboardFragment
import com.obsr.wallet.ui.start_activity.StartActivity
import com.obsr.wallet.utils.getPing
import com.obsr.wallet.R
import com.obsr.wallet.utils.TIME_OUT
...
class PincodeActivity : BaseActivity(), KeyboardFragment.onKeyListener {
    ...
    override fun onCreateView(savedInstanceState: Bundle?, container: ViewGroup) {
        ...
        if (coinApplication.appConf.pincode != null && !checkPin) {
            goNext()
            finish()
        }
    ...
    private fun goNext() {
        if (coinApplication.appConf.trustedNode == null) {
    ...
    private fun setNode(peerData: PeerData) {
        coinApplication.setTrustedServer(peerData)
        coinApplication.stopBlockchain()
    }

    private fun gotoWords() {
        coinApplication.appConf.isAppInit = true
    ...
    override fun onBackPressed() {
        super.onBackPressed()
        // todo: controlar esto
        if (coinApplication.appConf.pincode == null) {
