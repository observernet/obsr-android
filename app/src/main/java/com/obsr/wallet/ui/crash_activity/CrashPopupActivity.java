package com.obsr.wallet.ui.crash_activity;
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CoinApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.txt_send) {
            ...
            AndroidUtils.shareText(this, subject(), text, attachments);
            finish();
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ CoinApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException{
        return CoinApplication.getModule().getWallet().toString(false,true,true,null);
    }
}
