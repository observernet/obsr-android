package com.obsr.wallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = obsrModule.backupWallet(backupFile, firstPassword);

            if (result){
                coinApplication.getAppConf().setHasBackup(true);
