package com.obsr.wallet.ui.export_account;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = obsrModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(CoinCoreContext.NETWORK_PARAMETERS);
    ...
    private void loadQr(String text) throws WriterException {
        ...
        if (qrBitmap == null) {
            ...
            qrBitmap = QrUtils.encodeAsBitmap(text, px, px, Color.parseColor("#1A1A1A"), WHITE );
        }
