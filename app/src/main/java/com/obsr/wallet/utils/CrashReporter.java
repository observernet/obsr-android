...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final CoinApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (CoinCoreContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + CoinCoreContext.NETWORK_PARAMETERS.getId() + "\n");
