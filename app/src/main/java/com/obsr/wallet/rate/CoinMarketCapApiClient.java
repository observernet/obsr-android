...
public class CoinMarketCapApiClient {
    ...
    public class ObsrMarket {
        ...
        public ObsrMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestCoinRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestCoinRateException {
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
